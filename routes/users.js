...
let {registrar, verificar, ingresar, ingresarConToken, salir, verMisDatos, editarMisDatos} = require("../controllers/user")
...
let schemaEdit = require("../schemas/userEdit")
...
router.get("/me/:id", verMisDatos)
router.patch("/me/:id", validator(schemaEdit), editarMisDatos)
